		...
		if (guiBar.editorToggle){
			EditorGUILayout.BeginVertical(subGroupStyle);{
				...
				if (guiBar.previewToggle){
					...
					guiBar.bgPreview.guiTexture.pixelInset = new Rect(0, 0, guiBar.backgroundRect.width, guiBar.backgroundRect.height);
					guiBar.bgPreview.guiTexture.texture = guiBar.backgroundImage;
					guiBar.fillPreview.guiTexture.pixelInset = guiBar.fillRect;
					guiBar.fillPreview.guiTexture.texture = guiBar.fillImage;
